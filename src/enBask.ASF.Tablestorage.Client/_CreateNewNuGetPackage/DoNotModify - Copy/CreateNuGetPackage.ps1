...
{
	$folder = "$OutputDirectory/../../../../packages/ILMerge.2.14.1208/tools/ilmerge.exe"
	& $folder /ndebug /out:enBask.ASF.Tablestorage.Client.dll enBask.ASF.Tablestorage.Client.dll enBask.ASF.Tablestorage.Shared.dll
